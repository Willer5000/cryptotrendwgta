        ...
        try:
            ...
            for crypto in cryptos:
                try:
                    ...
                    processed_count += 1
                    progress = (processed_count / len(cryptos)) * 100
                    if processed_count % 10 == 0:
                        logger.info(f"Progreso: {processed_count}/{len(cryptos)} ({progress:.1f}%)")
...
def index():
    ...
    # Señales históricas (vela anterior)
